...
import com.github.salistito.finalreality.model.character.player.BlackMage;
import com.github.salistito.finalreality.model.character.player.Engineer;
...
public class BlackMageTest extends AbstractPlayerCharacterTest{
    ...
    @Test
    void toStringTest() {
        String expectedString = "BlackMage";
        assertEquals(expectedString, testBlackMage.toString());
    }
}
