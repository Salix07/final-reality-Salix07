...
class WeaponTest {
  ...
  private static final int MAGICDAMAGE = 20;
  ...
  void setUp() {
    ...
    testStaff = new Staff(STAFF_NAME, DAMAGE, MAGICDAMAGE, SPEED);
  ...
  void constructorTest() {
    ...
    var expectedStaff = new Staff(STAFF_NAME, DAMAGE, MAGICDAMAGE, SPEED);
